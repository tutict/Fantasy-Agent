...
- Mode: `Lightweight`.
- Current phase: frozen-inventory preregistration.
- Evidence Owner: root.
- Independent Reviewer: pending candidate freeze.
- Correction budget: `0 / 1` used.
- EXP-009 EII: 7 preregistration phase/cause groups observed; all recovered.
- Inventory membership: frozen by the preregistration commit containing
