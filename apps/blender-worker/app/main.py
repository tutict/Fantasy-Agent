...
from fantasy_agent.blender_mcp import (
    SERVER_NAME,
    SERVER_VERSION,
    call_blender_mcp_tool,
    tool_descriptors,
)
...
app = FastAPI(
    ...
    description="Prepares and executes controlled procedural Blender asset generation jobs.",
)
...
def _handle_rpc(message: dict[str, Any]) -> dict[str, Any] | None:
    ...
    if method == "tools/call":
        ...
        return _jsonrpc_result(request_id, call_blender_mcp_tool(name, arguments))
