...
app = FastAPI(
    ...
    description="Prepares and executes controlled gameplay-readable ComfyUI visual reference jobs.",
)
...
def _handle_rpc(message: dict[str, Any]) -> dict[str, Any] | None:
    ...
    if method == "tools/call":
        ...
        return _jsonrpc_result(request_id, call_comfyui_mcp_tool(name, arguments))
