...
export const studioI18n: Record<Locale, Dictionary> = {
  en: {
    ...
    apiEnabledHint: "When off, the pipeline stays fully deterministic.",
    ...
    agentHint: "Open-ended questions the fixed pipeline cannot answer. Runs on the provider configured in API access.",
    agentGoal: "Goal",
  ...
  "zh-CN": {
    ...
    apiEnabledHint: "关闭时，整条流水线保持完全确定性。",
    apiProvider: "Provider",
    apiBaseUrl: "Base URL",
    apiModel: "模型",
    apiKey: "API Key",
    ...
    agent: "Agent 循环",
    agentTitle: "有界规划循环",
    agentHint: "回答固定流水线答不了的开放式问题。使用「API 接入」里配置的 provider。",
    agentGoal: "目标",
...
export const workbenchI18n: Record<Locale, Dictionary> = {
  en: {
    ...
    seedEmpty: "Enter an idea, or answer the interview questions first.",
    ...
    toolExtractSeed: "Extract idea seed",
    ...
    noSeedYet: "No idea seed yet.",
    designPillars: "Design pillars",
    coreVerbs: "Core verbs",
    levelBeats: "Level beats",
