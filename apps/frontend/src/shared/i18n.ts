...
export const studioI18n: Record<Locale, Dictionary> = {
  en: {
    ...
    agentHint: "Open-ended questions the fixed pipeline cannot answer. Needs the openai_responses provider.",
    agentGoal: "Goal",
  ...
  "zh-CN": {
    ...
    agent: "Agent 循环",
    agentTitle: "有界规划循环",
    agentHint: "回答固定流水线答不了的开放式问题。需要 openai_responses provider。",
    agentGoal: "目标",
