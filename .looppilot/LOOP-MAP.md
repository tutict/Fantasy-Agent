...
|---|---|---|---|---|---|---|---|---|---|---|
| [ ] | LOOP-001 | Approval identity and ingest enforcement | blocked | none | approved | R2 NOT-CLOSEABLE; TASK-010 budget exhausted | yes | yes | `52173e0` rework committed; final not created | CHECKPOINT-029 |
